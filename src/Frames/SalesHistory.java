...
public class SalesHistory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        buttonClose.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                buttonCloseKeyPressed(evt);
            }
        });
        jPanel1.add(buttonClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(460, 620, 80, 34));
    ...
    private void buttonCloseKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_buttonCloseKeyPressed
        // TODO add your handling code here:
        if((int)evt.getKeyChar()==10)
        {
            this.buttonCloseActionPerformed(null);
        }
    }//GEN-LAST:event_buttonCloseKeyPressed
